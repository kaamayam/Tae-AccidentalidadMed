...
table(datos$GRAVEDAD, datos$AÑO) %>%kbl() %>%  kable_styling(font_size = 12)
...
aa=table(datos$CLASE_ACCIDENTE,datos$AÑO)
aa %>%kbl() %>%  kable_styling(font_size = 12)
...
r=table(datos$GRAVEDAD, datos$CLASE_ACCIDENTE)
r %>%kbl() %>%  kable_styling(font_size = 12)
...
db %>%kbl() %>%  kable_styling(font_size = 12)
