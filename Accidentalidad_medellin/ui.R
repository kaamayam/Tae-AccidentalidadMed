    ...
    dashboardBody(
      tabItems(
        ...
        tabItem(tabName = "p1",
                fluidPage(
                  sidebarPanel(width = 12,
                               ...
                               h5('1. Intervalo de tiempo: Podrás elegir una semana específica. '),
                               h5('2. Por fecha específica: Podrás elegir un día específico. '),
                               h5('3. Por mes espeficico: Podrás elegir un mes y un año específico. '),
                               fluidPage(
                                 div(align="center",
        ...
        tabItem(tabName = "p6",
                ...
                hr(),
                h5("3. Dando a conocerse un mapa y una tabla la cual contiene la cantidad de accidentes por tipo y buscando en el mapa donde posiblemente podrán ocurriran: "),
                hr(),
