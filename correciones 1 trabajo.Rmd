...
```{r}
datos <- readRDS("Accidentalidad_medellin/bases_datos/df.rds")
...
holidays_fecha<-readRDS("Accidentalidad_medellin/bases_datos/Holidays.rds") %>% data.frame()
...
```{r echo=T}
train<- readRDS("Accidentalidad_medellin/bases_datos/train.rds")
...
fit.1<-readRDS("Accidentalidad_medellin/bases_datos/Modelo.rds")
#summary(fit.1)
